...
const Profile = ({ darkMode, setDarkMode }) => {
  ...
  const fetchProfile = async () => {
    try {
      ...
      const mappedUser = mapUserToForm(response.data?.user);
        ...
        <section className="bg-gradient-to-r from-cyan-500 via-blue-500 to-indigo-600 rounded-3xl p-6 md:p-8 text-white shadow-xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="flex items-end gap-4">
              <div className="w-20 h-20 rounded-full bg-white/20 border-4 border-white flex items-center justify-center text-4xl">
                👤
              </div>
              <div>
          ...
          <div className="lg:col-span-2 bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 space-y-4">
            <div className="flex justify-between items-center mb-4">
              ...
              <button
                ...
                disabled={isSaving}
                className="px-4 py-2 rounded-lg bg-indigo-600 hover:bg-indigo-700 text-white font-semibold transition-colors disabled:opacity-70"
              >
                {isEditing
                  ? isSaving
                    ? "Đang lưu..."
            ...
            {error && (
              <div className="rounded-lg border border-red-200 bg-red-50 px-3 py-2 text-sm text-red-600 dark:border-red-800 dark:bg-red-900/30 dark:text-red-400">
                {error}
              </div>
            )}
          ...
          <div className="space-y-4">
            ...
            <div className="bg-red-600 rounded-2xl p-6 text-white shadow-sm">
              ...
              <p className="text-sm text-white/80 mb-4">
                Bạn muốn thoát khỏi tài khoản này?
              </p>
              <button
